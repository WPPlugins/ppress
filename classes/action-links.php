...
function pp_plugin_action_links( $actions, $plugin_file, $plugin_data, $context ) {
	$custom_actions = array(
		'themes' => sprintf( '<a href="%s" target="_blank">%s</a>', 'https://profilepress.net/themes', __( 'Buy Themes', 'profilepress' ) ),
		'upgrade'      => sprintf( '<a href="%s" target="_blank">%s</a>', 'https://profilepress.net/pricing/', __( 'Go Premium', 'profilepress' ) ),
	);

...
?>
<br/>
<a class="button-secondary" href="?page=<?php echo PASSWORD_RESET_BUILDER_SETTINGS_PAGE_SLUG; ?>" title="<?php _e( 'Back to Catalog',
				...
				<form method="post">
					<div class="postbox">
						...
						<div class="inside">
							<table class="form-table">
								<tr>
									<th scope="row"><label for="title"><?php _e( 'Theme Name', 'profilepress' ); ?></label></th>
									<td>
								...
								<tr>
									...
									<td>
										...
										<p class="description"><?php _e( 'Password Reset Form Design & Structure', 'profilepress' ); ?></p>
									</td>
								</tr>
							</table>
							...
							<p>
								...
								<input class="button-primary" type="submit" name="add_password_reset" value="<?php _e( 'Save Changes',
									'profilepress' ); ?>">
							</p>
						</div>
					</div>
					...
					<div style="margin-top: -5px;" class="postbox">
						...
						<h3 class="hndle ui-sortable-handle" style="font-size: 18px;text-align: center">
							<span><?php _e( 'Password Reset Form Preview', 'profilepress' ); ?></span></h3>
